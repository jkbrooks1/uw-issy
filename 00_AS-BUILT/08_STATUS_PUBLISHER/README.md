# 08_STATUS_PUBLISHER — As Built

**n8n workflow:** `v0001.08_StatusPublisherConnector`, id `gp8WlccGwLydNWG7`, 36 nodes, `active: false`.
**Status:** Live-verified. Reads all 7 connectors' real published output, rolls it up, writes `/files/uw-issy-connectors/public/status.json`.
